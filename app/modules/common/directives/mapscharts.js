...
//					console.log("$scope.projection="+$scope.projection);
                ...
                '<spectrum-colorpicker name="color" ng-model="scaleColor" ng-model-onblur options="{showInput: true, showAlpha: false, allowEmpty: false, preferredFormat:hex}"></spectrum-colorpicker>' + ' Scale Colour </label>' + '</div>' + '</div>'
            };
        }
    ])
