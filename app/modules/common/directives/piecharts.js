...
//array contetn like
    ...
    /*chartid (mandatory) = unique id for the visualisation*//*small (mandatory) = boolean, true or false to plot image size *//*labels = used to plot Y labels content*//*showLegend, showLabels boolean to configure the template */

    .directive('pcPieChart', [
                ...
                controller: function ($scope, $element, $attrs, $location, dialogs) {
                    ...
                    $scope.directivePlotPieChart = function () {
                        ...
                        var width = 980, height = 326, //radius = Math.min(width, height) / 2;
                            radius = 180, innerRadious = 50, font_size = 11;
