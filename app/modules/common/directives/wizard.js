...
.directive('wizardbar', ['$log', 'API_CONF', function ($log,  API_CONF) {
    ...
    return {
		...
		'<a class="help-nav-close" href="" ng-click="closeWizard()"></a><br/>'+
  		...
  		'<p>'+
  		'<strong>{{pillars[pillar][\'title\']}}. {{pillars[pillar][\'steps\'][stepRec][\'title\']}} ({{(step+0+1)}}/{{pillars[pillar][\'steps\'].length}}):</strong><br/>'+
  		'{{pillars[pillar][\'steps\'][stepRec][\'text\']}}'+
  		'</p>'+
