            ...
            return {
                ...
                baseVisualizationsCreateController: function ($scope, $route, $routeParams, $modal, Event, Metric, Dataset, Visualization, $location, helper, $log, API_CONF, Individual, Unit) {
                    ...
                    $scope.translateCountrySlider = function (value) {
                        ...
                        //console.log ($scope.translateCountryDataValue(value));
                        return $scope.translateCountryDataValue(value);
                    }
...
//								console.log($scope.dataset_color_palete_[puntero]);
                    ...
                    $scope.recoverRelatedData = function () {
                        ...
                        for (var i = 1; i < arguments.length; i++) {
                            ...
                            //console.log($scope.ResolutionToSend);
...
//			console.log(metric);
                ...
                for (x = 0; x < arrayConfigFilter.length; x++) {
                    ...
                    if (dataFilter[0] == 'graphSelected') {
                        ...
                        for (var i = 0; i < $scope.resolutionoptions.length; i++) {
                            ...
                            //console.log("$scope.resolutionoptions[i].value="+$scope.resolutionoptions[i].value);
                ...
                for (i in $scope.visualization.historical_events_in_visualization) {
                    ...
                    var datosInT = {
                        id: $scope.visualization.historical_events_in_visualization[i].historical_event_id, //title : $scope.visualization.historical_events_in_visualization[i].title,
                        title: titleEvent, //startDate : $scope.visualization.historical_events_in_visualization[i].startEventDate,
                        startDate: startEventDate, //endDate : $scope.visualization.historical_events_in_visualization[i].endEventDate,
...
//				console.log($scope.ListMetricsFilter);
            ...
            $scope.getEventDataDetail = function (posI, datIn, callback) {
                ...
                $scope.her = Event.get({id: datIn.historical_event_id}, function (her) {
                    ...
                    var myObject = {
                        id: her.id,
                        title: her.title, //startDate : her.startEventDate,
