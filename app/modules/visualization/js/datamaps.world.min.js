!function () {
    ...
    function b(a, b) {
        var c, d, e = b.width || a.offsetWidth, f = b.height || a.offsetHeight;
        return b && "undefined" == typeof b.scope && (b.scope = "world"), "usa" === b.scope ? c = l.geo.albersUsa().scale(e).translate([
            e / 2, f / 2
        ]) : "world" === b.scope && (c = l.geo[b.projection]().scale((e + 1) / 2 / Math.PI).translate([
            e / 2, f / ("mercator" === b.projection ? 1.45 : 1.8)
        ])), d = l.geo.path().projection(c), {
            path: d,
            projection: c
        }
    }
    ...
    function g(a, b, c) {
        ...
        e.enter().append("svg:path").attr("class", "datamaps-arc").style("stroke-linecap", "round").style("stroke", function (a) {
            ...
            var b = d.latLngToXY(a.origin.latitude, a.origin.longitude), e = d.latLngToXY(a.destination.latitude, a.destination.longitude), f = [
                (b[0] + e[0]) / 2, (b[1] + e[1]) / 2
            ];
    ...
    function h(a, b) {
        ...
        this.svg.selectAll(".datamaps-subunit").attr("data-foo", function (e) {
            ...
            [
                "FL", "KY", "MI"
            ].indexOf(e.id) > -1 && (g = -2.5), "NY" === e.id && (g = -1), "MI" === e.id && (h = 18), "LA" === e.id && (g = 13);
            var i, j;
            i = f[0] - g, j = f[1] + h;
    ...
    var l = window.d3, m = window.topojson, n = {
        scope: "world",
        setProjection: b,
    ...
    k.prototype.draw = function () {
        ...
        "undefined" == typeof k.prototype[a] && (k.prototype[a] = function (c, d, e, f) {
            var g;
            "undefined" == typeof f && (f = !1), "function" == typeof d && (e = d, d = void 0), d = j(d || {}, n[a + "Config"]), !f && this.options[a + "Layer"] ? (g = this.options[a + "Layer"], d = d || this.options[a + "Options"]) : (g = this.addLayer(a), this.options[a + "Layer"] = g, this.options[a + "Options"] = d), b.apply(this, [
                g, c, d
            ]), e && e(g)
        })
