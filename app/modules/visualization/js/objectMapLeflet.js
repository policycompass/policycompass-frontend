	...
	plotChartMap = function() {
		...
		if (self.legend) {
			legend.onAdd = function (map) {			
				...
				var grades = [self.minValueScale, (self.difMaxMinScale*2), (self.difMaxMinScale*3), (self.difMaxMinScale*4), (self.difMaxMinScale*5), (self.difMaxMinScale*6), (self.difMaxMinScale*7), self.maxDensityValue];
				var labels = [];
				var from;
				var to;
