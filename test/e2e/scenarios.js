...
describe('creation of a metric', function () {
    ...
    it('should create metric', function () {
        ...
        element(by.cssContainingText('option', 'Transport')).click();
        element(by.cssContainingText('option', 'Health')).click();
        element(by.cssContainingText('option', 'Second')).click();
        ...
        element(by.id('saveButton')).click().then(function () {
            ...
            element(by.xpath('/html/body/div[2]/div/h1')).getText().then(function (text) {
